import { HttpRequest, HttpResponseInit, app, InvocationContext } from "@azure/functions";
...
// Register the API Documentation endpoint
app.http("apiDocs", {
    methods: ["GET"],
    route: "api-docs",
...
// Register the List all tools endpoint
app.http("listTools", {
    methods: ["GET"],
    route: "tools",
    handler: async (request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> => {
...
// Register the Execute tool endpoint
